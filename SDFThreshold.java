...
public class SDFThreshold {
	...
	public static int f(String s1, String s2, int limit, int threshold) {
		/*
	...
	private static int gotThreshold(String s1, String s2) {
		int iT = 0;
		iT = Math.abs(s1.length() - s2.length());
