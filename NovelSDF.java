...
public class NovelSDF {
	 ...
	 */
	public static String mostOcurrencesElement(char[] array, int k) { // from Naive implementation
	...
	{
		int similarity = 0;
		char x1 []  = mostOcurrencesElement(s1.toCharArray(),2).toCharArray(); // from Naive implementation
		char x2 []  = mostOcurrencesElement(s2.toCharArray(),2).toCharArray(); // from Naive implementation

		/*
		 * New, from Andre, avoid errors and save some runTime.
		 * if S1 and S2 don't have at least 2 shared characters, the distance is to far...in our case does not matter.
		 * i.e. Comparing "my" with "a", x1[m,1,y,1], x2[a,1] it's clear and trivial that my this 2 string are not similar.
